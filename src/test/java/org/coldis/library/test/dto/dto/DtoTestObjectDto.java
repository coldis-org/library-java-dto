...
public class DtoTestObjectDto implements Serializable {
	 ...
	 * Serial.
	 */
	private static final long serialVersionUID = 776110365-1877623249L;
	...
	public DtoTestObjectDto(
			java.lang.Long id,
			org.coldis.library.test.dto.dto.DtoTestObject2Dto test1,
			java.util.List<org.coldis.library.test.dto.dto.DtoTestObject2Dto> test2,
			java.util.Map<String, Object> test4,
			org.coldis.library.test.dto.dto.DtoTestObject2Dto[] test6,
			int test7,
			int[] test88,
